...
# instance fields
.field private final boundary:Le/f;
...
.method constructor <init>(Le/f;Lokhttp3/MediaType;Ljava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 75
    iput-object p1, p0, Lokhttp3/MultipartBody;->boundary:Le/f;
...
.method private writeOrCountBytes(Le/d;Z)J
    .locals 12
    ...
    .line 138
    iget-object v8, p0, Lokhttp3/MultipartBody;->boundary:Le/f;

    invoke-interface {p1, v8}, Le/d;->d(Le/f;)Le/d;
    ...
    .line 160
    invoke-interface {v9, v7, v8}, Le/d;->n(J)Le/d;
    ...
    .line 173
    :cond_5
    invoke-virtual {v6, p1}, Lokhttp3/RequestBody;->writeTo(Le/d;)V
    ...
    .line 180
    iget-object v1, p0, Lokhttp3/MultipartBody;->boundary:Le/f;

    invoke-interface {p1, v1}, Le/d;->d(Le/f;)Le/d;
...
.method public boundary()Ljava/lang/String;
    ...
    .line 86
    iget-object v0, p0, Lokhttp3/MultipartBody;->boundary:Le/f;
...
.method public contentLength()J
    ...
    .line 110
    invoke-direct {p0, v0, v1}, Lokhttp3/MultipartBody;->writeOrCountBytes(Le/d;Z)J
...
.method public writeTo(Le/d;)V
    ...
    .line 114
    invoke-direct {p0, p1, v0}, Lokhttp3/MultipartBody;->writeOrCountBytes(Le/d;Z)J
