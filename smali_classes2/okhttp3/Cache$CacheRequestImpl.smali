...
# instance fields
.field private body:Le/s;

.field private cacheOut:Le/s;
...
.method constructor <init>(Lokhttp3/Cache;Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    .line 442
    invoke-virtual {p2, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)Le/s;

    move-result-object v0

    iput-object v0, p0, Lokhttp3/Cache$CacheRequestImpl;->cacheOut:Le/s;

    .line 443
    new-instance v0, Lokhttp3/Cache$CacheRequestImpl$1;

    iget-object v1, p0, Lokhttp3/Cache$CacheRequestImpl;->cacheOut:Le/s;

    invoke-direct {v0, p0, v1, p1, p2}, Lokhttp3/Cache$CacheRequestImpl$1;-><init>(Lokhttp3/Cache$CacheRequestImpl;Le/s;Lokhttp3/Cache;Lokhttp3/internal/cache/DiskLruCache$Editor;)V

    iput-object v0, p0, Lokhttp3/Cache$CacheRequestImpl;->body:Le/s;
...
.method public abort()V
    ...
    .line 466
    iget-object v0, p0, Lokhttp3/Cache$CacheRequestImpl;->cacheOut:Le/s;
...
.method public body()Le/s;
    .locals 1

    .line 474
    iget-object v0, p0, Lokhttp3/Cache$CacheRequestImpl;->body:Le/s;
