...
.method constructor <init>(Le/t;)V
    ...
    .line 550
    invoke-static {v0}, Lokhttp3/Cache;->readInt(Le/e;)I
    ...
    .line 584
    invoke-direct {p0, v0}, Lokhttp3/Cache$Entry;->readCertificateList(Le/e;)Ljava/util/List;
    ...
    .line 594
    :goto_4
    invoke-interface {p1}, Le/t;->close()V
...
.method private readCertificateList(Le/e;)Ljava/util/List;
    .locals 6
    ...
    .line 662
    invoke-static {p1}, Lokhttp3/Cache;->readInt(Le/e;)I
    ...
    .line 669
    invoke-interface {p1}, Le/e;->s()Ljava/lang/String;
...
.method private writeCertList(Le/d;Ljava/util/List;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0, v1}, Le/d;->n(J)Le/d;
...
.method public writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    .line 612
    invoke-virtual {p1, v0}, Lokhttp3/internal/cache/DiskLruCache$Editor;->newSink(I)Le/s;
    ...
    invoke-interface {p1, v3, v4}, Le/d;->n(J)Le/d;
    ...
    invoke-direct {p0, p1, v0}, Lokhttp3/Cache$Entry;->writeCertList(Le/d;Ljava/util/List;)V
