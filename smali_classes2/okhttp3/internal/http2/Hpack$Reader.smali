...
# direct methods
.method constructor <init>(IILe/t;)V
    .locals 1
    ...
    .line 137
    invoke-static {p3}, Le/l;->a(Le/t;)Le/e;

    move-result-object p1

    iput-object p1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Le/e;

    return-void
.end method

.method constructor <init>(ILe/t;)V
    .locals 0

    .line 131
    invoke-direct {p0, p1, p1, p2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(IILe/t;)V
...
.method private getName(I)Le/f;
    ...
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:Le/f;
...
.method private readByte()I
    ...
    .line 315
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Le/e;
...
.method private readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    .line 250
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)Le/f;

    move-result-object p1

    .line 251
    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()Le/f;
    ...
    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Le/f;Le/f;)V
...
.method private readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-static {v0}, Lokhttp3/internal/http2/Hpack;->checkLowercase(Le/f;)Le/f;
    ...
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Le/f;Le/f;)V
...
.method private readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Le/f;Le/f;)V
...
.method private readLiteralHeaderWithoutIndexingNewName()V
    ...
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Le/f;Le/f;)V
...
.method readByteString()Le/f;
    ...
    iget-object v2, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Le/e;

    int-to-long v3, v0

    invoke-interface {v2, v3, v4}, Le/e;->h(J)[B
    ...
    .line 349
    :cond_1
    iget-object v1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Le/e;

    int-to-long v2, v0

    invoke-interface {v1, v2, v3}, Le/e;->d(J)Le/f;
