...
.method constructor <init>(Le/e;Z)V
    ...
    .line 71
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Le/e;
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Le/e;

    invoke-direct {p1, p2}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Le/e;)V
    ...
    invoke-direct {p1, v0, p2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(ILe/t;)V
...
.method private readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 211
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Le/e;
    ...
    .line 214
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Le/e;

    invoke-interface {p1, v1, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILe/e;I)V

    .line 215
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Le/e;
...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 319
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Le/e;

    invoke-interface {p4}, Le/e;->k()I

    move-result p4

    .line 320
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Le/e;
    ...
    invoke-interface {p3, v1, v2}, Le/e;->d(J)Le/f;

    move-result-object p3

    .line 330
    :cond_0
    invoke-interface {p1, p4, v0, p3}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Le/f;)V
...
.method static readMedium(Le/e;)I
    .locals 2
...
.method private readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 229
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Le/e;
...
.method private readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 298
    :cond_0
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Le/e;
...
.method public nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-static {v1}, Lokhttp3/internal/http2/Http2Reader;->readMedium(Le/e;)I
    ...
    invoke-interface {p1, v0, v1}, Le/e;->i(J)V
...
.method public readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Le/f;
    ...
    invoke-interface {p1, v3, v4}, Le/e;->d(J)Le/f;
