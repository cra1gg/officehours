...
.method private newJournalWriter()Le/d;
    .locals 2
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->appendingSink(Ljava/io/File;)Le/s;
    ...
    invoke-direct {v1, p0, v0}, Lokhttp3/internal/cache/DiskLruCache$2;-><init>(Lokhttp3/internal/cache/DiskLruCache;Le/s;)V

    .line 322
    invoke-static {v1}, Le/l;->a(Le/s;)Le/d;
...
.method private readJournal()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Le/t;
    ...
    .line 278
    :try_start_0
    invoke-interface {v0}, Le/e;->s()Ljava/lang/String;
    ...
    .line 307
    :cond_0
    invoke-direct {p0}, Lokhttp3/internal/cache/DiskLruCache;->newJournalWriter()Le/d;

    move-result-object v1

    iput-object v1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Le/d;
    :try_end_2
...
.method public declared-synchronized close()V
    ...
    .line 677
    iget-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Le/d;
    ...
    .line 678
    iput-object v0, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Le/d;
...
.method declared-synchronized completeEdit(Lokhttp3/internal/cache/DiskLruCache$Editor;Z)V
    ...
    .line 574
    iget-object p1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Le/d;
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Le/d;)V
...
.method declared-synchronized edit(Ljava/lang/String;J)Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    .line 486
    :cond_3
    iget-object p2, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Le/d;
...
.method public declared-synchronized get(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    .line 447
    iget-object v1, p0, Lokhttp3/internal/cache/DiskLruCache;->journalWriter:Le/d;
...
.method declared-synchronized rebuildJournal()V
    ...
    invoke-interface {v0, v1}, Lokhttp3/internal/io/FileSystem;->sink(Ljava/io/File;)Le/s;
    ...
    invoke-interface {v0, v3, v4}, Le/d;->n(J)Le/d;
    ...
    .line 412
    invoke-virtual {v3, v0}, Lokhttp3/internal/cache/DiskLruCache$Entry;->writeLengths(Le/d;)V
