...
.method private buildCall()Lokhttp3/Call;
    ...
    .line 372
    :goto_3
    invoke-virtual {v0}, Lokhttp3/internal/huc/OutputStreamRequestBody;->timeout()Le/u;
    ...
    invoke-virtual {v1, v3, v4, v5}, Le/u;->timeout(JLjava/util/concurrent/TimeUnit;)Le/u;
...
.method private static toHumanReadableAscii(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 428
    invoke-virtual {v6, p0, v1, v2}, Le/c;->a(Ljava/lang/String;II)Le/c;

    const/16 v1, 0x3f

    .line 429
    invoke-virtual {v6, v1}, Le/c;->a(I)Le/c;
    ...
    .line 432
    :goto_2
    invoke-virtual {v6, v7}, Le/c;->a(I)Le/c;

    goto :goto_1

    .line 434
    :cond_2
    invoke-virtual {v6}, Le/c;->r()Ljava/lang/String;
