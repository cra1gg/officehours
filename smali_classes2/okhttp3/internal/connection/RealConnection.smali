...
.field private sink:Le/d;

.field private socket:Ljava/net/Socket;

.field private source:Le/e;
...
.method private connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Le/e;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Le/d;
    :try_end_1
...
.method private connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 227
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Le/d;

    .line 228
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Le/e;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Le/e;

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:Le/d;

    const/4 v3, 0x0

    invoke-direct {v0, v3, v3, v1, v2}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Le/e;Le/d;)V

    .line 372
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:Le/e;

    invoke-interface {v1}, Le/e;->timeout()Le/u;
    ...
    invoke-virtual {v1, v4, v5, v2}, Le/u;->timeout(JLjava/util/concurrent/TimeUnit;)Le/u;

    .line 373
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Le/d;

    invoke-interface {v1}, Le/d;->timeout()Le/u;
    ...
    .line 385
    :cond_0
    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Le/t;
    ...
    invoke-static {v0, v1, v2}, Lokhttp3/internal/Util;->skipAll(Le/t;ILjava/util/concurrent/TimeUnit;)Z
    ...
    .line 395
    :cond_4
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:Le/e;
    ...
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:Le/d;
...
.method private startHttp2(I)V
    ...
    iget-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:Le/e;

    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->sink:Le/d;

    invoke-virtual {v0, v1, v2, v3, v4}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Le/e;Le/d;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 176
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->source:Le/e;

    .line 177
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->sink:Le/d;
...
.method public isHealthy(Z)Z
    ...
    .line 561
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:Le/e;
...
.method public newCodec(Lokhttp3/OkHttpClient;Lokhttp3/Interceptor$Chain;Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/http/HttpCodec;
    ...
    invoke-interface {v0}, Le/e;->timeout()Le/u;
    ...
    invoke-virtual {v0, v1, v2, v3}, Le/u;->timeout(JLjava/util/concurrent/TimeUnit;)Le/u;

    .line 520
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->sink:Le/d;
    ...
    invoke-virtual {v0, v1, v2, p2}, Le/u;->timeout(JLjava/util/concurrent/TimeUnit;)Le/u;
    ...
    invoke-direct {p2, p1, p3, v0, v1}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;Le/e;Le/d;)V
...
.method public newWebSocketStreams(Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/connection/RealConnection$1;-><init>(Lokhttp3/internal/connection/RealConnection;ZLe/e;Le/d;Lokhttp3/internal/connection/StreamAllocation;)V
