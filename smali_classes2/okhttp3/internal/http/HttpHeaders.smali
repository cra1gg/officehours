...
# static fields
.field private static final QUOTED_STRING_DELIMITERS:Le/f;

.field private static final TOKEN_DELIMITERS:Le/f;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lokhttp3/internal/http/HttpHeaders;->QUOTED_STRING_DELIMITERS:Le/f;
    ...
    sput-object v0, Lokhttp3/internal/http/HttpHeaders;->TOKEN_DELIMITERS:Le/f;
...
.method private static parseChallengeHeader(Ljava/util/List;Le/c;)V
    .locals 8
    ...
    .line 185
    invoke-static {p1}, Lokhttp3/internal/http/HttpHeaders;->skipWhitespaceAndCommas(Le/c;)Z

    .line 186
    invoke-static {p1}, Lokhttp3/internal/http/HttpHeaders;->readToken(Le/c;)Ljava/lang/String;
    ...
    .line 201
    invoke-static {p1, v4}, Lokhttp3/internal/http/HttpHeaders;->skipAll(Le/c;B)I
    ...
    invoke-virtual {p1, v6, v7}, Le/c;->c(J)B
    ...
    .line 226
    invoke-static {p1}, Lokhttp3/internal/http/HttpHeaders;->readQuotedString(Le/c;)Ljava/lang/String;
...
.method public static parseChallenges(Lokhttp3/Headers;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-virtual {v2, v3}, Le/c;->a(Ljava/lang/String;)Le/c;

    move-result-object v2

    .line 173
    invoke-static {v0, v2}, Lokhttp3/internal/http/HttpHeaders;->parseChallengeHeader(Ljava/util/List;Le/c;)V
...
.method private static readQuotedString(Le/c;)Ljava/lang/String;
    .locals 11
    ...
    .line 273
    :goto_0
    sget-object v2, Lokhttp3/internal/http/HttpHeaders;->QUOTED_STRING_DELIMITERS:Le/f;

    invoke-virtual {p0, v2}, Le/c;->c(Le/f;)J
    ...
    .line 277
    invoke-virtual {v0, p0, v2, v3}, Le/c;->write(Le/c;J)V
    ...
    .line 285
    invoke-virtual {v0, p0, v7, v8}, Le/c;->write(Le/c;J)V
...
.method private static readToken(Le/c;)Ljava/lang/String;
    .locals 4

    .line 295
    :try_start_0
    sget-object v0, Lokhttp3/internal/http/HttpHeaders;->TOKEN_DELIMITERS:Le/f;

    invoke-virtual {p0, v0}, Le/c;->c(Le/f;)J
...
.method private static skipAll(Le/c;B)I
    .locals 3
    ...
    invoke-virtual {p0, v1, v2}, Le/c;->c(J)B
...
.method private static skipWhitespaceAndCommas(Le/c;)Z
    .locals 3
