...
.method private declared-synchronized send(Le/f;I)Z
    .locals 6
    ...
    invoke-direct {v1, p2, p1}, Lokhttp3/internal/ws/RealWebSocket$Message;-><init>(ILe/f;)V
...
.method declared-synchronized close(ILjava/lang/String;J)Z
    ...
    invoke-direct {v2, p1, v0, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILe/f;J)V
...
.method public connect(Lokhttp3/OkHttpClient;)V
    ...
    invoke-interface {p1}, Lokhttp3/Call;->timeout()Le/u;

    move-result-object p1

    invoke-virtual {p1}, Le/u;->clearTimeout()Le/u;
...
.method public initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    iget-object v2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->sink:Le/d;

    iget-object v3, p0, Lokhttp3/internal/ws/RealWebSocket;->random:Ljava/util/Random;

    invoke-direct {v0, v1, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLe/d;Ljava/util/Random;)V
    ...
    iget-object p2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->source:Le/e;

    invoke-direct {p1, v0, p2, p0}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLe/e;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
...
.method public onReadMessage(Le/f;)V
    .locals 1

    .line 327
    iget-object v0, p0, Lokhttp3/internal/ws/RealWebSocket;->listener:Lokhttp3/WebSocketListener;

    invoke-virtual {v0, p0, p1}, Lokhttp3/WebSocketListener;->onMessage(Lokhttp3/WebSocket;Le/f;)V
...
.method public declared-synchronized onReadPing(Le/f;)V
    .locals 1
...
.method public declared-synchronized onReadPong(Le/f;)V
    .locals 0
...
.method declared-synchronized pong(Le/f;)Z
    .locals 1
...
.method public send(Le/f;)Z
    ...
    .line 381
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/RealWebSocket;->send(Le/f;I)Z
...
.method writeOneFrame()Z
    ...
    .line 494
    :try_start_1
    invoke-virtual {v0, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(Le/f;)V
    ...
    iget-object v1, v1, Lokhttp3/internal/ws/RealWebSocket$Message;->data:Le/f;
    ...
    .line 498
    invoke-virtual {v0, v2, v5, v6}, Lokhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)Le/s;
    ...
    .line 500
    invoke-interface {v0, v1}, Le/d;->d(Le/f;)Le/d;
    ...
    iget-object v3, v5, Lokhttp3/internal/ws/RealWebSocket$Close;->reason:Le/f;

    invoke-virtual {v0, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILe/f;)V
...
.method writePingFrame()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/ws/WebSocketWriter;->writePing(Le/f;)V
    :try_end_1
