...
.method private a(Lorg/spongycastle/x509/X509AttributeCertificate;Ljava/security/cert/X509Certificate;Lorg/spongycastle/jcajce/PKIXExtendedBuilderParameters;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
    .locals 5
    ...
    .line 205
    :cond_0
    invoke-virtual {p3}, Lorg/spongycastle/jcajce/PKIXExtendedBuilderParameters;->b()Ljava/util/Set;
    ...
    .line 210
    :cond_1
    invoke-virtual {p3}, Lorg/spongycastle/jcajce/PKIXExtendedBuilderParameters;->c()I
    ...
    .line 239
    :try_start_1
    invoke-virtual {p3}, Lorg/spongycastle/jcajce/PKIXExtendedBuilderParameters;->a()Lorg/spongycastle/jcajce/PKIXExtendedParameters;

    move-result-object v3

    invoke-virtual {v3}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->i()Ljava/util/Set;
    ...
    invoke-virtual {v4}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->k()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->a()Ljava/util/List;
    ...
    .line 280
    :try_start_5
    sget-object v2, Lorg/spongycastle/asn1/x509/Extension;->f:Lorg/spongycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-virtual {v3}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->b()Ljava/util/Map;

    move-result-object v3

    invoke-static {v2, v3}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->a([BLjava/util/Map;)Ljava/util/List;
    ...
    invoke-virtual {v3}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->p()Ljava/util/List;

    move-result-object v3

    invoke-static {p2, v3, v0}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->a(Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/util/List;)Ljava/util/Collection;
    ...
    .line 318
    :cond_4
    invoke-direct {p0, p1, v2, p3, p4}, Lorg/spongycastle/jce/provider/PKIXAttrCertPathBuilderSpi;->a(Lorg/spongycastle/x509/X509AttributeCertificate;Ljava/security/cert/X509Certificate;Lorg/spongycastle/jcajce/PKIXExtendedBuilderParameters;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
...
.method public engineBuild(Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathBuilderResult;
    ...
    .line 82
    invoke-virtual {p1}, Lorg/spongycastle/x509/ExtendedPKIXBuilderParameters;->a()Ljava/util/Set;

    move-result-object v1

    invoke-virtual {v0, v1}, Lorg/spongycastle/jcajce/PKIXExtendedBuilderParameters$Builder;->a(Ljava/util/Set;)Lorg/spongycastle/jcajce/PKIXExtendedBuilderParameters$Builder;

    .line 83
    invoke-virtual {p1}, Lorg/spongycastle/x509/ExtendedPKIXBuilderParameters;->b()I

    move-result v1

    invoke-virtual {v0, v1}, Lorg/spongycastle/jcajce/PKIXExtendedBuilderParameters$Builder;->a(I)Lorg/spongycastle/jcajce/PKIXExtendedBuilderParameters$Builder;
    ...
    .line 87
    :cond_2
    invoke-virtual {v0}, Lorg/spongycastle/jcajce/PKIXExtendedBuilderParameters$Builder;->a()Lorg/spongycastle/jcajce/PKIXExtendedBuilderParameters;
    ...
    .line 101
    invoke-virtual {p1}, Lorg/spongycastle/jcajce/PKIXExtendedBuilderParameters;->a()Lorg/spongycastle/jcajce/PKIXExtendedParameters;

    move-result-object v2

    invoke-virtual {v2}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->h()Lorg/spongycastle/jcajce/PKIXCertStoreSelector;
    ...
    invoke-static {v2, v1}, Lorg/spongycastle/jce/provider/PKIXAttrCertPathBuilderSpi;->a(Lorg/spongycastle/x509/X509AttributeCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    ...
    invoke-virtual {v8}, Lorg/spongycastle/jcajce/PKIXCertStoreSelector$Builder;->a()Lorg/spongycastle/jcajce/PKIXCertStoreSelector;
    ...
    invoke-virtual {v9}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->p()Ljava/util/List;

    move-result-object v9

    invoke-static {v8, v9}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->a(Lorg/spongycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    ...
    invoke-virtual {v9}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->a()Ljava/util/List;
    ...
    invoke-direct {p0, v3, v2, p1, v0}, Lorg/spongycastle/jce/provider/PKIXAttrCertPathBuilderSpi;->a(Lorg/spongycastle/x509/X509AttributeCertificate;Ljava/security/cert/X509Certificate;Lorg/spongycastle/jcajce/PKIXExtendedBuilderParameters;Ljava/util/List;)Ljava/security/cert/CertPathBuilderResult;
