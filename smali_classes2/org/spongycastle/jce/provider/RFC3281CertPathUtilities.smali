...
.method protected static a(Ljava/security/cert/CertPath;Lorg/spongycastle/jcajce/PKIXExtendedParameters;)Ljava/security/cert/CertPathValidatorResult;
    .locals 2
...
.method protected static a(Ljava/security/cert/X509Certificate;Lorg/spongycastle/jcajce/PKIXExtendedParameters;)V
    .locals 1
...
.method private static a(Lorg/spongycastle/asn1/x509/DistributionPoint;Lorg/spongycastle/x509/X509AttributeCertificate;Lorg/spongycastle/jcajce/PKIXExtendedParameters;Ljava/util/Date;Ljava/security/cert/X509Certificate;Lorg/spongycastle/jce/provider/CertStatus;Lorg/spongycastle/jce/provider/ReasonsMask;Ljava/util/List;Lorg/spongycastle/jcajce/util/JcaJceHelper;)V
    ...
    .line 610
    invoke-static {v1, v9, v14, v10}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->a(Lorg/spongycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/util/Date;Lorg/spongycastle/jcajce/PKIXExtendedParameters;)Ljava/util/Set;
    ...
    .line 642
    invoke-static {v3, v2}, Lorg/spongycastle/jce/provider/RFC3280CertPathUtilities;->a(Ljava/security/cert/X509CRL;Ljava/util/Set;)Ljava/security/PublicKey;

    move-result-object v2

    .line 646
    invoke-virtual/range {p2 .. p2}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->f()Z
    ...
    .line 649
    invoke-virtual/range {p2 .. p2}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->p()Ljava/util/List;

    move-result-object v4

    invoke-virtual/range {p2 .. p2}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->c()Ljava/util/List;

    move-result-object v5

    invoke-static {v14, v3, v4, v5}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->a(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;

    move-result-object v4

    .line 652
    invoke-static {v4, v2}, Lorg/spongycastle/jce/provider/RFC3280CertPathUtilities;->a(Ljava/util/Set;Ljava/security/PublicKey;)Ljava/security/cert/X509CRL;
    ...
    .line 669
    :goto_1
    invoke-virtual/range {p2 .. p2}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->g()I
    ...
    :cond_4
    :goto_2
    invoke-static {v1, v9, v3}, Lorg/spongycastle/jce/provider/RFC3280CertPathUtilities;->b(Lorg/spongycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V

    .line 687
    invoke-static {v1, v9, v3}, Lorg/spongycastle/jce/provider/RFC3280CertPathUtilities;->a(Lorg/spongycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/security/cert/X509CRL;)V

    .line 690
    invoke-static {v2, v3, v10}, Lorg/spongycastle/jce/provider/RFC3280CertPathUtilities;->a(Ljava/security/cert/X509CRL;Ljava/security/cert/X509CRL;Lorg/spongycastle/jcajce/PKIXExtendedParameters;)V

    .line 693
    invoke-static {v11, v2, v9, v12, v10}, Lorg/spongycastle/jce/provider/RFC3280CertPathUtilities;->a(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/spongycastle/jce/provider/CertStatus;Lorg/spongycastle/jcajce/PKIXExtendedParameters;)V

    .line 697
    invoke-static {v11, v3, v9, v12}, Lorg/spongycastle/jce/provider/RFC3280CertPathUtilities;->a(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/spongycastle/jce/provider/CertStatus;)V
    ...
    .line 703
    invoke-virtual {v12, v2}, Lorg/spongycastle/jce/provider/CertStatus;->a(I)V

    :cond_5
    move-object/from16 v2, v19

    .line 707
    invoke-virtual {v13, v2}, Lorg/spongycastle/jce/provider/ReasonsMask;->a(Lorg/spongycastle/jce/provider/ReasonsMask;)V
    :try_end_1
...
.method protected static a(Lorg/spongycastle/x509/X509AttributeCertificate;Ljava/security/cert/CertPath;Ljava/security/cert/CertPath;Lorg/spongycastle/jcajce/PKIXExtendedParameters;Ljava/util/Set;)V
    .locals 1
    ...
    invoke-virtual {v0, p0, p1, p2, p3}, Lorg/spongycastle/x509/PKIXAttrCertChecker;->a(Lorg/spongycastle/x509/X509AttributeCertificate;Ljava/security/cert/CertPath;Ljava/security/cert/CertPath;Ljava/util/Collection;)V
...
.method protected static a(Lorg/spongycastle/x509/X509AttributeCertificate;Ljava/util/Set;Ljava/util/Set;)V
    .locals 2
    ...
    .line 319
    invoke-interface {p0, p2}, Lorg/spongycastle/x509/X509AttributeCertificate;->a(Ljava/lang/String;)[Lorg/spongycastle/x509/X509Attribute;
...
.method protected static a(Lorg/spongycastle/x509/X509AttributeCertificate;Lorg/spongycastle/jcajce/PKIXExtendedParameters;)V
    .locals 1

    .line 334
    :try_start_0
    invoke-static {p1}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->a(Lorg/spongycastle/jcajce/PKIXExtendedParameters;)Ljava/util/Date;
...
.method protected static a(Lorg/spongycastle/x509/X509AttributeCertificate;Lorg/spongycastle/jcajce/PKIXExtendedParameters;Ljava/security/cert/X509Certificate;Ljava/util/Date;Ljava/util/List;Lorg/spongycastle/jcajce/util/JcaJceHelper;)V
    .locals 18

    move-object/from16 v10, p0

    .line 134
    invoke-virtual/range {p1 .. p1}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->q()Z
    ...
    .line 143
    invoke-static {v10, v0}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->a(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lorg/spongycastle/asn1/ASN1Primitive;
    ...
    .line 156
    :try_start_1
    invoke-virtual/range {p1 .. p1}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->d()Ljava/util/Map;
    ...
    invoke-virtual {v2, v4}, Lorg/spongycastle/jcajce/PKIXExtendedParameters$Builder;->a(Lorg/spongycastle/jcajce/PKIXCRLStore;)Lorg/spongycastle/jcajce/PKIXExtendedParameters$Builder;
    ...
    .line 195
    invoke-virtual {v12}, Lorg/spongycastle/jce/provider/CertStatus;->b()I
    ...
    .line 196
    invoke-virtual {v13}, Lorg/spongycastle/jce/provider/ReasonsMask;->a()Z
    ...
    :try_start_4
    invoke-static/range {v1 .. v9}, Lorg/spongycastle/jce/provider/RFC3281CertPathUtilities;->a(Lorg/spongycastle/asn1/x509/DistributionPoint;Lorg/spongycastle/x509/X509AttributeCertificate;Lorg/spongycastle/jcajce/PKIXExtendedParameters;Ljava/util/Date;Ljava/security/cert/X509Certificate;Lorg/spongycastle/jce/provider/CertStatus;Lorg/spongycastle/jce/provider/ReasonsMask;Ljava/util/List;Lorg/spongycastle/jcajce/util/JcaJceHelper;)V
    :try_end_4
    ...
    .line 279
    invoke-virtual {v12, v1}, Lorg/spongycastle/jce/provider/CertStatus;->a(I)V
    ...
    .line 270
    invoke-virtual {v12}, Lorg/spongycastle/jce/provider/CertStatus;->a()Ljava/util/Date;
...
.method protected static b(Lorg/spongycastle/x509/X509AttributeCertificate;Lorg/spongycastle/jcajce/PKIXExtendedParameters;)Ljava/security/cert/CertPath;
    .locals 7
    ...
    invoke-virtual {v1}, Lorg/spongycastle/x509/AttributeCertificateHolder;->e()[Ljava/security/Principal;
    ...
    invoke-virtual {v3}, Lorg/spongycastle/x509/AttributeCertificateHolder;->f()Ljava/math/BigInteger;
    ...
    invoke-virtual {v3}, Lorg/spongycastle/x509/AttributeCertificateHolder;->e()[Ljava/security/Principal;
    ...
    .line 461
    invoke-virtual {v5}, Lorg/spongycastle/jcajce/PKIXCertStoreSelector$Builder;->a()Lorg/spongycastle/jcajce/PKIXCertStoreSelector;

    move-result-object v5

    invoke-virtual {p1}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->p()Ljava/util/List;

    move-result-object v6

    invoke-static {v5, v6}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->a(Lorg/spongycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    ...
    invoke-virtual {v1}, Lorg/spongycastle/x509/AttributeCertificateHolder;->d()[Ljava/security/Principal;
    ...
    invoke-virtual {p0}, Lorg/spongycastle/x509/AttributeCertificateHolder;->d()[Ljava/security/Principal;
    ...
    .line 495
    invoke-virtual {v3}, Lorg/spongycastle/jcajce/PKIXCertStoreSelector$Builder;->a()Lorg/spongycastle/jcajce/PKIXCertStoreSelector;
    ...
    invoke-static {v3, v4}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->a(Lorg/spongycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    ...
    invoke-virtual {p0, v2}, Lorg/spongycastle/jcajce/PKIXExtendedParameters$Builder;->a(Lorg/spongycastle/jcajce/PKIXCertStoreSelector;)Lorg/spongycastle/jcajce/PKIXExtendedParameters$Builder;
    ...
    invoke-virtual {p0}, Lorg/spongycastle/jcajce/PKIXExtendedParameters$Builder;->a()Lorg/spongycastle/jcajce/PKIXExtendedParameters;
    ...
    invoke-virtual {v3}, Lorg/spongycastle/jcajce/PKIXExtendedBuilderParameters$Builder;->a()Lorg/spongycastle/jcajce/PKIXExtendedBuilderParameters;
