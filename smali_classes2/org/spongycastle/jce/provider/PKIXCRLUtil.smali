...
.method private final a(Lorg/spongycastle/jcajce/PKIXCRLStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    .locals 6
    ...
    .line 97
    :try_start_0
    invoke-interface {v3, p1}, Lorg/spongycastle/util/Store;->a(Lorg/spongycastle/util/Selector;)Ljava/util/Collection;
    ...
    .line 112
    :try_start_1
    invoke-static {p1, v3}, Lorg/spongycastle/jcajce/PKIXCRLStoreSelector;->a(Lorg/spongycastle/jcajce/PKIXCRLStoreSelector;Ljava/security/cert/CertStore;)Ljava/util/Collection;
...
# virtual methods
.method public a(Lorg/spongycastle/jcajce/PKIXCRLStoreSelector;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    .locals 3
    ...
    .line 29
    :try_start_0
    invoke-direct {p0, p1, p4}, Lorg/spongycastle/jce/provider/PKIXCRLUtil;->a(Lorg/spongycastle/jcajce/PKIXCRLStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    ...
    .line 30
    invoke-direct {p0, p1, p3}, Lorg/spongycastle/jce/provider/PKIXCRLUtil;->a(Lorg/spongycastle/jcajce/PKIXCRLStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    ...
    .line 46
    invoke-virtual {p1}, Lorg/spongycastle/jcajce/PKIXCRLStoreSelector;->c()Ljava/security/cert/X509Certificate;
