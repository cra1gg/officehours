...
.method protected static a(Ljava/util/List;ILorg/spongycastle/jcajce/util/JcaJceHelper;)Ljava/security/PublicKey;
    .locals 3
    ...
    .line 1239
    invoke-interface {p2, p0}, Lorg/spongycastle/jcajce/util/JcaJceHelper;->d(Ljava/lang/String;)Ljava/security/KeyFactory;
...
.method protected static a(Ljava/security/cert/X509Certificate;Ljava/util/Set;Ljava/lang/String;)Ljava/security/cert/TrustAnchor;
    ...
    .line 166
    invoke-static {p0}, Lorg/spongycastle/jce/provider/PrincipalUtils;->a(Ljava/lang/Object;)Lorg/spongycastle/asn1/x500/X500Name;
    ...
    .line 197
    :try_start_1
    invoke-static {v3}, Lorg/spongycastle/jce/provider/PrincipalUtils;->a(Ljava/security/cert/TrustAnchor;)Lorg/spongycastle/asn1/x500/X500Name;
...
.method static a(Ljava/security/cert/X509Certificate;Ljava/util/List;Ljava/util/List;)Ljava/util/Collection;
    ...
    .line 1268
    :try_start_0
    invoke-static {p0}, Lorg/spongycastle/jce/provider/PrincipalUtils;->b(Ljava/security/cert/X509Certificate;)Lorg/spongycastle/asn1/x500/X500Name;
    ...
    .line 1278
    :try_start_1
    sget-object v1, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->n:Ljava/lang/String;
    ...
    invoke-static {p0}, Lorg/spongycastle/asn1/x509/AuthorityKeyIdentifier;->a(Ljava/lang/Object;)Lorg/spongycastle/asn1/x509/AuthorityKeyIdentifier;

    move-result-object p0

    invoke-virtual {p0}, Lorg/spongycastle/asn1/x509/AuthorityKeyIdentifier;->a()[B
    ...
    .line 1304
    invoke-static {p0, p2}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->a(Lorg/spongycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
...
.method protected static a(Lorg/spongycastle/jcajce/PKIXCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    .locals 3
    ...
    .line 663
    :try_start_0
    invoke-interface {v1, p0}, Lorg/spongycastle/util/Store;->a(Lorg/spongycastle/util/Selector;)Ljava/util/Collection;
    ...
    .line 677
    :try_start_1
    invoke-static {p0, v1}, Lorg/spongycastle/jcajce/PKIXCertStoreSelector;->a(Lorg/spongycastle/jcajce/PKIXCertStoreSelector;Ljava/security/cert/CertStore;)Ljava/util/Collection;
...
.method protected static a(Lorg/spongycastle/jcajce/PKIXExtendedParameters;)Ljava/util/Date;
    .locals 0

    .line 276
    invoke-virtual {p0}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->e()Ljava/util/Date;
...
.method protected static a(Lorg/spongycastle/jcajce/PKIXExtendedParameters;Ljava/security/cert/CertPath;I)Ljava/util/Date;
    .locals 2

    .line 1125
    invoke-virtual {p0}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->g()I
    ...
    .line 1130
    invoke-static {p0}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->a(Lorg/spongycastle/jcajce/PKIXExtendedParameters;)Ljava/util/Date;
    ...
    invoke-static {p0}, Lorg/spongycastle/asn1/ASN1GeneralizedTime;->a(Ljava/lang/Object;)Lorg/spongycastle/asn1/ASN1GeneralizedTime;
...
.method static a(Lorg/spongycastle/asn1/x509/CRLDistPoint;Ljava/util/Map;)Ljava/util/List;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v3}, Lorg/spongycastle/asn1/x509/DistributionPoint;->a()Lorg/spongycastle/asn1/x509/DistributionPointName;
...
.method protected static a(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1029
    invoke-virtual {v2, p1}, Lorg/spongycastle/jcajce/PKIXCRLStoreSelector$Builder;->a([B)V

    const/4 p1, 0x1

    .line 1030
    invoke-virtual {v2, p1}, Lorg/spongycastle/jcajce/PKIXCRLStoreSelector$Builder;->b(Z)V

    .line 1033
    invoke-virtual {v2, v1}, Lorg/spongycastle/jcajce/PKIXCRLStoreSelector$Builder;->a(Ljava/math/BigInteger;)V

    .line 1035
    invoke-virtual {v2}, Lorg/spongycastle/jcajce/PKIXCRLStoreSelector$Builder;->a()Lorg/spongycastle/jcajce/PKIXCRLStoreSelector;
    ...
    invoke-virtual {v0, p1, p0, p2, p3}, Lorg/spongycastle/jce/provider/PKIXCRLUtil;->a(Lorg/spongycastle/jcajce/PKIXCRLStoreSelector;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;
    ...
    .line 1046
    invoke-static {p2}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->a(Ljava/security/cert/X509CRL;)Z
...
.method protected static a(Lorg/spongycastle/asn1/x509/DistributionPoint;Ljava/lang/Object;Ljava/util/Date;Lorg/spongycastle/jcajce/PKIXExtendedParameters;)Ljava/util/Set;
    .locals 3
    ...
    invoke-virtual {p0, v0}, Lorg/spongycastle/jcajce/PKIXCRLStoreSelector$Builder;->a(Z)Lorg/spongycastle/jcajce/PKIXCRLStoreSelector$Builder;

    move-result-object p0

    invoke-virtual {p0}, Lorg/spongycastle/jcajce/PKIXCRLStoreSelector$Builder;->a()Lorg/spongycastle/jcajce/PKIXCRLStoreSelector;

    move-result-object p0

    .line 1109
    invoke-virtual {p3}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->e()Ljava/util/Date;
    ...
    invoke-virtual {p3}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->p()Ljava/util/List;

    move-result-object v1

    invoke-virtual {p3}, Lorg/spongycastle/jcajce/PKIXExtendedParameters;->c()Ljava/util/List;

    move-result-object p3

    invoke-virtual {v0, p0, p2, v1, p3}, Lorg/spongycastle/jce/provider/PKIXCRLUtil;->a(Lorg/spongycastle/jcajce/PKIXCRLStoreSelector;Ljava/util/Date;Ljava/util/List;Ljava/util/List;)Ljava/util/Set;

    move-result-object p0

    .line 1116
    invoke-static {p0, p1}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->a(Ljava/util/Set;Ljava/lang/Object;)V
...
.method protected static a(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lorg/spongycastle/jce/provider/CertStatus;)V
    ...
    .line 887
    invoke-static {p2}, Lorg/spongycastle/jce/provider/CertPathValidatorUtilities;->a(Ljava/lang/Object;)Ljava/math/BigInteger;
    ...
    .line 906
    :goto_0
    invoke-static {p2}, Lorg/spongycastle/jce/provider/PrincipalUtils;->a(Ljava/lang/Object;)Lorg/spongycastle/asn1/x500/X500Name;
    ...
    .line 930
    :try_start_1
    sget-object p1, Lorg/spongycastle/asn1/x509/Extension;->i:Lorg/spongycastle/asn1/ASN1ObjectIdentifier;
    ...
    .line 931
    invoke-static {p1}, Lorg/spongycastle/asn1/ASN1Enumerated;->a(Ljava/lang/Object;)Lorg/spongycastle/asn1/ASN1Enumerated;
    ...
    .line 947
    invoke-virtual {p1}, Lorg/spongycastle/asn1/ASN1Enumerated;->b()Ljava/math/BigInteger;
    ...
    invoke-virtual {p3, p0}, Lorg/spongycastle/jce/provider/CertStatus;->a(I)V
    ...
    invoke-virtual {p3, p0}, Lorg/spongycastle/jce/provider/CertStatus;->a(Ljava/util/Date;)V
...
.method static a(Ljava/util/Set;Ljava/lang/Object;)V
    ...
    sget-object v1, Lorg/spongycastle/asn1/x500/style/RFC4519Style;->R:Lorg/spongycastle/asn1/x500/X500NameStyle;

    invoke-static {p1}, Lorg/spongycastle/jce/provider/PrincipalUtils;->b(Ljava/security/cert/X509Certificate;)Lorg/spongycastle/asn1/x500/X500Name;

    move-result-object p1

    invoke-interface {v1, p1}, Lorg/spongycastle/asn1/x500/X500NameStyle;->b(Lorg/spongycastle/asn1/x500/X500Name;)Ljava/lang/String;
...
.method protected static a(Lorg/spongycastle/asn1/x509/DistributionPoint;Ljava/util/Collection;Ljava/security/cert/X509CRLSelector;)V
    .locals 3
    ...
    invoke-virtual {p1}, Lorg/spongycastle/asn1/x500/X500Name;->f()[B
...
.method private static a(Ljava/security/cert/X509CRL;)Z
    ...
    .line 1064
    :cond_0
    sget-object v0, Lorg/spongycastle/jce/provider/RFC3280CertPathUtilities;->f:Ljava/lang/String;
