...
.method public constructor <init>(Lorg/spongycastle/crypto/Digest;)V
    ...
    .line 38
    iget-object p1, p0, Lorg/spongycastle/crypto/generators/PKCS5S2ParametersGenerator;->d:Lorg/spongycastle/crypto/Mac;
    ...
    iput-object p1, p0, Lorg/spongycastle/crypto/generators/PKCS5S2ParametersGenerator;->e:[B
...
.method private a([BI[B[BI)V
    ...
    invoke-interface {p1, p3, v0, v1}, Lorg/spongycastle/crypto/Mac;->a([BII)V

    .line 59
    iget-object p1, p0, Lorg/spongycastle/crypto/generators/PKCS5S2ParametersGenerator;->d:Lorg/spongycastle/crypto/Mac;

    iget-object p3, p0, Lorg/spongycastle/crypto/generators/PKCS5S2ParametersGenerator;->e:[B

    invoke-interface {p1, p3, v0}, Lorg/spongycastle/crypto/Mac;->a([BI)I

    .line 61
    iget-object p1, p0, Lorg/spongycastle/crypto/generators/PKCS5S2ParametersGenerator;->e:[B
    ...
    .line 65
    iget-object p3, p0, Lorg/spongycastle/crypto/generators/PKCS5S2ParametersGenerator;->d:Lorg/spongycastle/crypto/Mac;

    iget-object v1, p0, Lorg/spongycastle/crypto/generators/PKCS5S2ParametersGenerator;->e:[B

    iget-object v2, p0, Lorg/spongycastle/crypto/generators/PKCS5S2ParametersGenerator;->e:[B

    array-length v2, v2

    invoke-interface {p3, v1, v0, v2}, Lorg/spongycastle/crypto/Mac;->a([BII)V
    ...
    invoke-interface {p3, v1, v0}, Lorg/spongycastle/crypto/Mac;->a([BI)I
...
.method private c(I)[B
    ...
    iget-object v4, p0, Lorg/spongycastle/crypto/generators/PKCS5S2ParametersGenerator;->a:[B

    invoke-direct {v3, v4}, Lorg/spongycastle/crypto/params/KeyParameter;-><init>([B)V

    .line 86
    iget-object v4, p0, Lorg/spongycastle/crypto/generators/PKCS5S2ParametersGenerator;->d:Lorg/spongycastle/crypto/Mac;

    invoke-interface {v4, v3}, Lorg/spongycastle/crypto/Mac;->a(Lorg/spongycastle/crypto/CipherParameters;)V
    ...
    .line 97
    :cond_0
    iget-object v4, p0, Lorg/spongycastle/crypto/generators/PKCS5S2ParametersGenerator;->b:[B

    iget v5, p0, Lorg/spongycastle/crypto/generators/PKCS5S2ParametersGenerator;->c:I
    ...
    invoke-direct/range {v3 .. v8}, Lorg/spongycastle/crypto/generators/PKCS5S2ParametersGenerator;->a([BI[B[BI)V
...
.method public a(I)Lorg/spongycastle/crypto/CipherParameters;
    ...
    invoke-static {v0, v1, p1}, Lorg/spongycastle/util/Arrays;->a([BII)[B
