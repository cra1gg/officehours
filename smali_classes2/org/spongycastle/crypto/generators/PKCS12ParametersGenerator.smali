...
.method private b(II)[B
    ...
    .line 91
    :cond_0
    iget-object p1, p0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->b:[B
    ...
    .line 93
    iget p1, p0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->f:I

    iget-object v4, p0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->b:[B

    array-length v4, v4

    iget v5, p0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->f:I
    ...
    .line 97
    iget-object v5, p0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->b:[B

    iget-object v6, p0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->b:[B
    ...
    .line 107
    :cond_2
    iget-object v4, p0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->a:[B
    ...
    .line 109
    iget v4, p0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->f:I

    iget-object v5, p0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->a:[B

    array-length v5, v5

    iget v6, p0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->f:I
    ...
    .line 127
    iget v4, p0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->e:I
    ...
    .line 132
    iget-object v7, p0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->d:Lorg/spongycastle/crypto/Digest;
    ...
    invoke-interface {v7, v4, v2}, Lorg/spongycastle/crypto/Digest;->a([BI)I

    const/4 v7, 0x1

    .line 135
    :goto_4
    iget v8, p0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->c:I

    if-ge v7, v8, :cond_5

    .line 137
    iget-object v8, p0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->d:Lorg/spongycastle/crypto/Digest;

    array-length v9, v4

    invoke-interface {v8, v4, v2, v9}, Lorg/spongycastle/crypto/Digest;->a([BII)V

    .line 138
    iget-object v8, p0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->d:Lorg/spongycastle/crypto/Digest;

    invoke-interface {v8, v4, v2}, Lorg/spongycastle/crypto/Digest;->a([BI)I
    ...
    iget v9, p0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->f:I
    ...
    .line 148
    iget v8, p0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->f:I

    mul-int v8, v8, v7

    invoke-direct {p0, v5, v8, p1}, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->a([BI[B)V
    ...
    .line 153
    iget v8, p0, Lorg/spongycastle/crypto/generators/PKCS12ParametersGenerator;->e:I
