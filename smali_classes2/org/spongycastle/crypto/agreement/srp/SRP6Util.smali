...
.method public static a(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    .line 56
    sget-object p1, Lorg/spongycastle/crypto/agreement/srp/SRP6Util;->a:Ljava/math/BigInteger;
...
.method public static a(Lorg/spongycastle/crypto/Digest;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    .line 44
    sget-object p2, Lorg/spongycastle/crypto/agreement/srp/SRP6Util;->b:Ljava/math/BigInteger;
    ...
    .line 47
    invoke-static {p0, p1, p3}, Lorg/spongycastle/util/BigIntegers;->a(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
...
.method public static a(Lorg/spongycastle/crypto/Digest;Ljava/math/BigInteger;[B[B[B)Ljava/math/BigInteger;
    ...
    invoke-interface {p0, p3, v1, v0}, Lorg/spongycastle/crypto/Digest;->a([BII)V

    const/16 p3, 0x3a

    .line 30
    invoke-interface {p0, p3}, Lorg/spongycastle/crypto/Digest;->a(B)V

    .line 31
    array-length p3, p4

    invoke-interface {p0, p4, v1, p3}, Lorg/spongycastle/crypto/Digest;->a([BII)V

    .line 32
    invoke-interface {p0, p1, v1}, Lorg/spongycastle/crypto/Digest;->a([BI)I

    .line 34
    array-length p3, p2

    invoke-interface {p0, p2, v1, p3}, Lorg/spongycastle/crypto/Digest;->a([BII)V

    .line 35
    array-length p2, p1

    invoke-interface {p0, p1, v1, p2}, Lorg/spongycastle/crypto/Digest;->a([BII)V
...
.method private static b(Lorg/spongycastle/crypto/Digest;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    .line 132
    invoke-static {p2, p1}, Lorg/spongycastle/crypto/agreement/srp/SRP6Util;->a(Ljava/math/BigInteger;I)[B

    move-result-object p2

    .line 133
    invoke-static {p3, p1}, Lorg/spongycastle/crypto/agreement/srp/SRP6Util;->a(Ljava/math/BigInteger;I)[B
    ...
    invoke-interface {p0, p2, v0, p3}, Lorg/spongycastle/crypto/Digest;->a([BII)V

    .line 136
    array-length p2, p1

    invoke-interface {p0, p1, v0, p2}, Lorg/spongycastle/crypto/Digest;->a([BII)V
    ...
    .line 139
    invoke-interface {p0, p1, v0}, Lorg/spongycastle/crypto/Digest;->a([BI)I
