...
.method private static a(Ljava/math/BigInteger;Lorg/spongycastle/math/ec/ECFieldElement;)Ljava/math/BigInteger;
    ...
    invoke-static {p1, p0}, Lorg/spongycastle/crypto/signers/DSTU4145Signer;->a(Ljava/math/BigInteger;I)Ljava/math/BigInteger;
...
.method private static a(Lorg/spongycastle/math/ec/ECCurve;[B)Lorg/spongycastle/math/ec/ECFieldElement;
    ...
    invoke-static {v0, p1}, Lorg/spongycastle/crypto/signers/DSTU4145Signer;->a(Ljava/math/BigInteger;I)Ljava/math/BigInteger;
...
.method public a(ZLorg/spongycastle/crypto/CipherParameters;)V
    ...
    iput-object p1, p0, Lorg/spongycastle/crypto/signers/DSTU4145Signer;->c:Ljava/security/SecureRandom;
...
.method public a([BLjava/math/BigInteger;Ljava/math/BigInteger;)Z
    ...
    .line 120
    invoke-static {v3, p1}, Lorg/spongycastle/crypto/signers/DSTU4145Signer;->a(Lorg/spongycastle/math/ec/ECCurve;[B)Lorg/spongycastle/math/ec/ECFieldElement;
    ...
    .line 123
    sget-object p1, Lorg/spongycastle/crypto/signers/DSTU4145Signer;->a:Ljava/math/BigInteger;

    invoke-virtual {v3, p1}, Lorg/spongycastle/math/ec/ECCurve;->a(Ljava/math/BigInteger;)Lorg/spongycastle/math/ec/ECFieldElement;
    ...
    iget-object v3, p0, Lorg/spongycastle/crypto/signers/DSTU4145Signer;->b:Lorg/spongycastle/crypto/params/ECKeyParameters;
    ...
    invoke-static {v0, p3, v3, p2}, Lorg/spongycastle/math/ec/ECAlgorithms;->a(Lorg/spongycastle/math/ec/ECPoint;Ljava/math/BigInteger;Lorg/spongycastle/math/ec/ECPoint;Ljava/math/BigInteger;)Lorg/spongycastle/math/ec/ECPoint;

    move-result-object p3

    invoke-virtual {p3}, Lorg/spongycastle/math/ec/ECPoint;->p()Lorg/spongycastle/math/ec/ECPoint;

    move-result-object p3

    .line 129
    invoke-virtual {p3}, Lorg/spongycastle/math/ec/ECPoint;->q()Z
    ...
    invoke-virtual {p1, p3}, Lorg/spongycastle/math/ec/ECFieldElement;->c(Lorg/spongycastle/math/ec/ECFieldElement;)Lorg/spongycastle/math/ec/ECFieldElement;

    move-result-object p1

    .line 135
    invoke-static {v2, p1}, Lorg/spongycastle/crypto/signers/DSTU4145Signer;->a(Ljava/math/BigInteger;Lorg/spongycastle/math/ec/ECFieldElement;)Ljava/math/BigInteger;
...
.method public a([B)[Ljava/math/BigInteger;
    ...
    invoke-virtual {v1, p1}, Lorg/spongycastle/math/ec/ECCurve;->a(Ljava/math/BigInteger;)Lorg/spongycastle/math/ec/ECFieldElement;
    ...
    .line 76
    iget-object v2, p0, Lorg/spongycastle/crypto/signers/DSTU4145Signer;->b:Lorg/spongycastle/crypto/params/ECKeyParameters;
    ...
    .line 86
    :cond_1
    iget-object v4, p0, Lorg/spongycastle/crypto/signers/DSTU4145Signer;->c:Ljava/security/SecureRandom;

    invoke-static {v1, v4}, Lorg/spongycastle/crypto/signers/DSTU4145Signer;->a(Ljava/math/BigInteger;Ljava/security/SecureRandom;)Ljava/math/BigInteger;
    ...
    invoke-interface {v3, v5, v4}, Lorg/spongycastle/math/ec/ECMultiplier;->a(Lorg/spongycastle/math/ec/ECPoint;Ljava/math/BigInteger;)Lorg/spongycastle/math/ec/ECPoint;
    ...
    .line 91
    invoke-virtual {p1, v5}, Lorg/spongycastle/math/ec/ECFieldElement;->c(Lorg/spongycastle/math/ec/ECFieldElement;)Lorg/spongycastle/math/ec/ECFieldElement;

    move-result-object v5

    .line 92
    invoke-static {v1, v5}, Lorg/spongycastle/crypto/signers/DSTU4145Signer;->a(Ljava/math/BigInteger;Lorg/spongycastle/math/ec/ECFieldElement;)Ljava/math/BigInteger;
