...
.method public constructor <init>(Lorg/spongycastle/crypto/Digest;)V
    ...
    .line 34
    iget-object p1, p0, Lorg/spongycastle/crypto/signers/HMacDSAKCalculator;->b:Lorg/spongycastle/crypto/macs/HMac;

    invoke-virtual {p1}, Lorg/spongycastle/crypto/macs/HMac;->b()I

    move-result p1

    new-array p1, p1, [B

    iput-object p1, p0, Lorg/spongycastle/crypto/signers/HMacDSAKCalculator;->d:[B
    ...
    iput-object p1, p0, Lorg/spongycastle/crypto/signers/HMacDSAKCalculator;->c:[B
...
.method private a([B)Ljava/math/BigInteger;
    ...
    iget-object v1, p0, Lorg/spongycastle/crypto/signers/HMacDSAKCalculator;->e:Ljava/math/BigInteger;
...
.method public a(Ljava/math/BigInteger;Ljava/math/BigInteger;[B)V
    ...
    .line 69
    :cond_0
    invoke-static {p3}, Lorg/spongycastle/util/BigIntegers;->a(Ljava/math/BigInteger;)[B
    ...
    invoke-virtual {p1, p3}, Lorg/spongycastle/crypto/macs/HMac;->a(Lorg/spongycastle/crypto/CipherParameters;)V

    .line 75
    iget-object p1, p0, Lorg/spongycastle/crypto/signers/HMacDSAKCalculator;->b:Lorg/spongycastle/crypto/macs/HMac;

    iget-object p3, p0, Lorg/spongycastle/crypto/signers/HMacDSAKCalculator;->d:[B

    iget-object v3, p0, Lorg/spongycastle/crypto/signers/HMacDSAKCalculator;->d:[B

    array-length v3, v3

    invoke-virtual {p1, p3, v2, v3}, Lorg/spongycastle/crypto/macs/HMac;->a([BII)V

    .line 76
    iget-object p1, p0, Lorg/spongycastle/crypto/signers/HMacDSAKCalculator;->b:Lorg/spongycastle/crypto/macs/HMac;

    invoke-virtual {p1, v2}, Lorg/spongycastle/crypto/macs/HMac;->a(B)V
    ...
    invoke-virtual {p1, v0, v2, p3}, Lorg/spongycastle/crypto/macs/HMac;->a([BII)V
    ...
    invoke-virtual {p1, p2, v2, p3}, Lorg/spongycastle/crypto/macs/HMac;->a([BII)V

    .line 80
    iget-object p1, p0, Lorg/spongycastle/crypto/signers/HMacDSAKCalculator;->b:Lorg/spongycastle/crypto/macs/HMac;

    iget-object p3, p0, Lorg/spongycastle/crypto/signers/HMacDSAKCalculator;->c:[B

    invoke-virtual {p1, p3, v2}, Lorg/spongycastle/crypto/macs/HMac;->a([BI)I
    ...
    invoke-virtual {p1, v1}, Lorg/spongycastle/crypto/macs/HMac;->a(B)V
    ...
    iget-object p2, p0, Lorg/spongycastle/crypto/signers/HMacDSAKCalculator;->c:[B

    invoke-virtual {p1, p2, v2}, Lorg/spongycastle/crypto/macs/HMac;->a([BI)I
    ...
    invoke-virtual {p1, p2}, Lorg/spongycastle/crypto/macs/HMac;->a(Lorg/spongycastle/crypto/CipherParameters;)V

    .line 97
    iget-object p1, p0, Lorg/spongycastle/crypto/signers/HMacDSAKCalculator;->b:Lorg/spongycastle/crypto/macs/HMac;

    iget-object p2, p0, Lorg/spongycastle/crypto/signers/HMacDSAKCalculator;->d:[B
...
.method public b()Ljava/math/BigInteger;
    ...
    .line 121
    :cond_0
    invoke-direct {p0, v0}, Lorg/spongycastle/crypto/signers/HMacDSAKCalculator;->a([B)Ljava/math/BigInteger;
    ...
    .line 128
    :cond_1
    iget-object v2, p0, Lorg/spongycastle/crypto/signers/HMacDSAKCalculator;->b:Lorg/spongycastle/crypto/macs/HMac;
    ...
    invoke-virtual {v2, v3, v1, v4}, Lorg/spongycastle/crypto/macs/HMac;->a([BII)V

    .line 129
    iget-object v2, p0, Lorg/spongycastle/crypto/signers/HMacDSAKCalculator;->b:Lorg/spongycastle/crypto/macs/HMac;

    invoke-virtual {v2, v1}, Lorg/spongycastle/crypto/macs/HMac;->a(B)V
    ...
    invoke-virtual {v2, v3, v1}, Lorg/spongycastle/crypto/macs/HMac;->a([BI)I
    ...
    invoke-virtual {v2, v3}, Lorg/spongycastle/crypto/macs/HMac;->a(Lorg/spongycastle/crypto/CipherParameters;)V
