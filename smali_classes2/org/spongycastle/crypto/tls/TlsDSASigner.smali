...
.method protected a(Lorg/spongycastle/crypto/tls/SignatureAndHashAlgorithm;ZZLorg/spongycastle/crypto/CipherParameters;)Lorg/spongycastle/crypto/Signer;
    ...
    invoke-virtual {p0, p1}, Lorg/spongycastle/crypto/tls/TlsDSASigner;->a(S)Lorg/spongycastle/crypto/DSA;
    ...
    invoke-interface {v0, p3, p1}, Lorg/spongycastle/crypto/Signer;->a(ZLorg/spongycastle/crypto/CipherParameters;)V
...
.method public a(Lorg/spongycastle/crypto/tls/SignatureAndHashAlgorithm;[BLorg/spongycastle/crypto/params/AsymmetricKeyParameter;[B)Z
    ...
    .line 38
    invoke-virtual {p0, p1, v1, v0, p3}, Lorg/spongycastle/crypto/tls/TlsDSASigner;->a(Lorg/spongycastle/crypto/tls/SignatureAndHashAlgorithm;ZZLorg/spongycastle/crypto/CipherParameters;)Lorg/spongycastle/crypto/Signer;
    ...
    .line 42
    invoke-interface {p3, p4, p1, v0}, Lorg/spongycastle/crypto/Signer;->a([BII)V
    ...
    invoke-interface {p3, p4, v0, p1}, Lorg/spongycastle/crypto/Signer;->a([BII)V

    .line 48
    :goto_0
    invoke-interface {p3, p2}, Lorg/spongycastle/crypto/Signer;->a([B)Z
...
.method public a(Lorg/spongycastle/crypto/tls/SignatureAndHashAlgorithm;Lorg/spongycastle/crypto/params/AsymmetricKeyParameter;[B)[B
    ...
    .line 20
    invoke-virtual {p0, p1, p2, p2, v0}, Lorg/spongycastle/crypto/tls/TlsDSASigner;->a(Lorg/spongycastle/crypto/tls/SignatureAndHashAlgorithm;ZZLorg/spongycastle/crypto/CipherParameters;)Lorg/spongycastle/crypto/Signer;
    ...
    .line 25
    invoke-interface {p2, p3, p1, v0}, Lorg/spongycastle/crypto/Signer;->a([BII)V
    ...
    .line 31
    :goto_0
    invoke-interface {p2}, Lorg/spongycastle/crypto/Signer;->a()[B
