...
.field private i:Lorg/spongycastle/crypto/params/ParametersWithIV;
...
.method protected constructor <init>(Lorg/spongycastle/crypto/StreamCipher;III)V
    ...
    .line 48
    iput v2, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->j:I

    const/4 v0, 0x0

    .line 50
    iput-object v0, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->k:Ljavax/crypto/spec/PBEParameterSpec;

    .line 51
    iput-object v0, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->l:Ljava/lang/String;
    ...
    .line 67
    iput p2, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->j:I

    .line 68
    iput p3, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->g:I

    .line 69
    iput p4, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->h:I
...
.method protected engineDoFinal([BII[BI)I
    ...
    .line 393
    iget-object v2, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->f:Lorg/spongycastle/crypto/StreamCipher;
    ...
    invoke-interface {p1}, Lorg/spongycastle/crypto/StreamCipher;->c()V
...
.method protected engineDoFinal([BII)[B
    ...
    invoke-interface {p2}, Lorg/spongycastle/crypto/StreamCipher;->c()V
...
.method protected engineGetIV()[B
    ...
    .line 79
    iget-object v0, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->i:Lorg/spongycastle/crypto/params/ParametersWithIV;
...
.method protected engineGetParameters()Ljava/security/AlgorithmParameters;
    ...
    .line 98
    iget-object v0, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->k:Ljavax/crypto/spec/PBEParameterSpec;

    if-eqz v0, :cond_0

    .line 102
    :try_start_0
    iget-object v0, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->l:Ljava/lang/String;

    invoke-virtual {p0, v0}, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->b(Ljava/lang/String;)Ljava/security/AlgorithmParameters;

    move-result-object v0

    .line 103
    iget-object v1, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->k:Ljavax/crypto/spec/PBEParameterSpec;
...
.method protected engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    iput-object p3, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->k:Ljavax/crypto/spec/PBEParameterSpec;
    ...
    iget-object p3, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->k:Ljavax/crypto/spec/PBEParameterSpec;
    ...
    iget v4, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->h:I

    iget v5, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->g:I

    iget p2, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->j:I

    mul-int/lit8 v6, p2, 0x8

    iget-object v7, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->k:Ljavax/crypto/spec/PBEParameterSpec;

    iget-object p2, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->f:Lorg/spongycastle/crypto/StreamCipher;

    invoke-interface {p2}, Lorg/spongycastle/crypto/StreamCipher;->a()Ljava/lang/String;

    move-result-object v8

    invoke-static/range {v2 .. v8}, Lorg/spongycastle/jcajce/provider/symmetric/util/PBE$Util;->a([BIIIILjava/security/spec/AlgorithmParameterSpec;Ljava/lang/String;)Lorg/spongycastle/crypto/CipherParameters;
    ...
    iput-object p2, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->i:Lorg/spongycastle/crypto/params/ParametersWithIV;
    ...
    .line 210
    iget p3, p0, Lorg/spongycastle/jcajce/provider/symmetric/util/BaseStreamCipher;->h:I
