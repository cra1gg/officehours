...
.method private static final a(Ljava/lang/CharSequence;Ljava/lang/CharSequence;IIZZ)I
    ...
    .line 876
    invoke-static {p2, v0}, Ld/d/d;->b(II)I

    move-result p2

    new-instance p5, Ld/d/c;

    invoke-interface {p0}, Ljava/lang/CharSequence;->length()I

    move-result v0

    invoke-static {p3, v0}, Ld/d/d;->c(II)I

    move-result p3

    invoke-direct {p5, p2, p3}, Ld/d/c;-><init>(II)V

    check-cast p5, Ld/d/a;

    goto :goto_0

    .line 878
    :cond_0
    invoke-static {p0}, Ld/f/d;->a(Ljava/lang/CharSequence;)I

    move-result p5

    invoke-static {p2, p5}, Ld/d/d;->c(II)I

    move-result p2

    invoke-static {p3, v0}, Ld/d/d;->b(II)I

    move-result p3

    invoke-static {p2, p3}, Ld/d/d;->a(II)Ld/d/a;
    ...
    .line 881
    invoke-virtual {p5}, Ld/d/a;->a()I

    move-result p2

    invoke-virtual {p5}, Ld/d/a;->b()I

    move-result p3

    invoke-virtual {p5}, Ld/d/a;->c()I
    ...
    invoke-static/range {v0 .. v5}, Ld/f/d;->a(Ljava/lang/CharSequence;ILjava/lang/CharSequence;IIZ)Z
...
.method static synthetic a(Ljava/lang/CharSequence;Ljava/lang/CharSequence;IIZZILjava/lang/Object;)I
    ...
    .line 874
    invoke-static/range {v0 .. v5}, Ld/f/m;->a(Ljava/lang/CharSequence;Ljava/lang/CharSequence;IIZZ)I
...
.method public static final a(Ljava/lang/CharSequence;Ljava/lang/String;IZ)I
    ...
    invoke-static/range {v0 .. v7}, Ld/f/m;->a(Ljava/lang/CharSequence;Ljava/lang/CharSequence;IIZZILjava/lang/Object;)I
...
.method public static synthetic a(Ljava/lang/CharSequence;Ljava/lang/String;IZILjava/lang/Object;)I
    ...
    .line 1002
    :cond_1
    invoke-static {p0, p1, p2, p3}, Ld/f/d;->a(Ljava/lang/CharSequence;Ljava/lang/String;IZ)I
...
.method public static final a(Ljava/lang/CharSequence;ILjava/lang/CharSequence;IIZ)Z
    ...
    invoke-static {v2, v3, p5}, Ld/f/a;->a(CCZ)Z
