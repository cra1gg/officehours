...
.method draw(Landroid/graphics/Canvas;Landroid/graphics/Paint;F)V
    ...
    .line 73
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/SymbolView;->saveDefinition()V
...
.method drawSymbol(Landroid/graphics/Canvas;Landroid/graphics/Paint;FFF)V
    ...
    iget v2, p0, Lversioned/host/exp/exponent/modules/api/components/svg/SymbolView;->mScale:F

    mul-float v1, v1, v2

    iget v2, p0, Lversioned/host/exp/exponent/modules/api/components/svg/SymbolView;->mMinY:F

    iget v3, p0, Lversioned/host/exp/exponent/modules/api/components/svg/SymbolView;->mScale:F

    mul-float v2, v2, v3

    iget v3, p0, Lversioned/host/exp/exponent/modules/api/components/svg/SymbolView;->mMinX:F

    iget v4, p0, Lversioned/host/exp/exponent/modules/api/components/svg/SymbolView;->mVbWidth:F

    add-float/2addr v3, v4

    iget v4, p0, Lversioned/host/exp/exponent/modules/api/components/svg/SymbolView;->mScale:F

    mul-float v3, v3, v4

    iget v4, p0, Lversioned/host/exp/exponent/modules/api/components/svg/SymbolView;->mMinY:F

    iget v5, p0, Lversioned/host/exp/exponent/modules/api/components/svg/SymbolView;->mVbHeight:F

    add-float/2addr v4, v5

    iget v5, p0, Lversioned/host/exp/exponent/modules/api/components/svg/SymbolView;->mScale:F
...
.method public setAlign(Ljava/lang/String;)V
    ...
    .line 62
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/SymbolView;->invalidate()V
