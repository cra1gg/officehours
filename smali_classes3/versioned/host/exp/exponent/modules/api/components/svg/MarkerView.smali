...
.method renderMarker(Landroid/graphics/Canvas;Landroid/graphics/Paint;FLversioned/host/exp/exponent/modules/api/components/svg/RNSVGMarkerPosition;F)V
    ...
    .line 133
    iget-object v0, p0, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->mCTM:Landroid/graphics/Matrix;

    invoke-virtual {p0, p1, v0}, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->saveAndSetupCanvas(Landroid/graphics/Canvas;Landroid/graphics/Matrix;)I
    ...
    iget v4, p0, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->mScale:F

    mul-float v3, v3, v4

    iget-wide v4, v1, Lversioned/host/exp/exponent/modules/api/components/svg/Point;->y:D
    ...
    .line 139
    iget-object v2, p0, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->mOrient:Ljava/lang/String;
    ...
    .line 143
    iget-object v1, p0, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->mMarkerUnits:Ljava/lang/String;
    ...
    invoke-virtual {p0, p4}, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->relativeOnWidth(Lversioned/host/exp/exponent/modules/api/components/svg/SVGLength;)D

    move-result-wide p4

    iget v1, p0, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->mScale:F
    ...
    invoke-virtual {p0, v1}, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->relativeOnHeight(Lversioned/host/exp/exponent/modules/api/components/svg/SVGLength;)D

    move-result-wide v1

    iget v3, p0, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->mScale:F
    ...
    iget v1, p0, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->mMinY:F

    iget v2, p0, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->mScale:F

    mul-float v1, v1, v2

    iget v2, p0, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->mMinX:F

    iget v4, p0, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->mVbWidth:F
    ...
    iget v5, p0, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->mVbHeight:F

    add-float/2addr v4, v5

    iget v5, p0, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->mScale:F
    ...
    .line 165
    invoke-virtual {p0, p1, p2, p3}, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->drawGroup(Landroid/graphics/Canvas;Landroid/graphics/Paint;F)V

    .line 167
    invoke-virtual {p0, p1, v0}, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->restoreCanvas(Landroid/graphics/Canvas;I)V
...
.method saveDefinition()V
    ...
    .line 120
    iget-object v0, p0, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->mName:Ljava/lang/String;

    if-eqz v0, :cond_1

    .line 121
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->getSvgView()Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;

    move-result-object v0

    .line 122
    iget-object v1, p0, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->mName:Ljava/lang/String;
    ...
    .line 123
    :goto_0
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->getChildCount()I
    ...
    .line 124
    invoke-virtual {p0, v0}, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->getChildAt(I)Landroid/view/View;
...
.method public setAlign(Ljava/lang/String;)V
    ...
    .line 109
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/MarkerView;->invalidate()V
