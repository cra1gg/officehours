...
.method private clearChildCache()V
    ...
    .line 164
    :goto_0
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;->getChildCount()I
    ...
    .line 165
    invoke-virtual {p0, v0}, Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;->getChildAt(I)Landroid/view/View;
...
.method private drawOutput()Landroid/graphics/Bitmap;
    ...
    .line 242
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;->getWidth()I
    ...
    .line 243
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;->getHeight()I
...
.method private getViewBox()Landroid/graphics/RectF;
    ...
    iget v2, p0, Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;->mMinY:F

    iget v3, p0, Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;->mScale:F

    mul-float v2, v2, v3

    iget v3, p0, Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;->mMinX:F

    iget v4, p0, Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;->mVbWidth:F

    add-float/2addr v3, v4

    iget v4, p0, Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;->mScale:F

    mul-float v3, v3, v4

    iget v4, p0, Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;->mMinY:F

    iget v5, p0, Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;->mVbHeight:F

    add-float/2addr v4, v5

    iget v5, p0, Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;->mScale:F
...
.method private hitTest(FF)I
    ...
    .line 371
    invoke-virtual {p0, v2}, Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;->getChildAt(I)Landroid/view/View;
    ...
    .line 382
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;->getId()I
...
.method declared-synchronized drawChildren(Landroid/graphics/Canvas;)V
    ...
    .line 269
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;->getParent()Landroid/view/ViewParent;
    ...
    .line 291
    invoke-virtual {p0, v4}, Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;->getChildAt(I)Landroid/view/View;
    ...
    .line 298
    invoke-virtual {p0, v3}, Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;->getChildAt(I)Landroid/view/View;
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 110
    iput-object v1, p0, Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;->toDataUrlTask:Ljava/lang/Runnable;
