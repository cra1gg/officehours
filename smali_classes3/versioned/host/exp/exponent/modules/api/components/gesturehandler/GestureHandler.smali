...
.method private adaptEvent(Landroid/view/MotionEvent;)Landroid/view/MotionEvent;
    ...
    .line 263
    sget-object v3, Lversioned/host/exp/exponent/modules/api/components/gesturehandler/GestureHandler;->sPointerCoords:[Landroid/view/MotionEvent$PointerCoords;
...
.method private static initPointerProps(I)V
    ...
    sput-object v0, Lversioned/host/exp/exponent/modules/api/components/gesturehandler/GestureHandler;->sPointerProps:[Landroid/view/MotionEvent$PointerProperties;
...
.method public final handle(Landroid/view/MotionEvent;)V
    ...
    .line 301
    iget-boolean v2, p0, Lversioned/host/exp/exponent/modules/api/components/gesturehandler/GestureHandler;->mShouldCancelWhenOutside:Z

    if-eqz v2, :cond_3

    iget-boolean v2, p0, Lversioned/host/exp/exponent/modules/api/components/gesturehandler/GestureHandler;->mWithinBounds:Z
...
.method public isWithinBounds(Landroid/view/View;FF)Z
    ...
    .line 383
    iget-object v5, p0, Lversioned/host/exp/exponent/modules/api/components/gesturehandler/GestureHandler;->mHitSlop:[F

    aget v5, v5, v2

    .line 384
    iget-object v6, p0, Lversioned/host/exp/exponent/modules/api/components/gesturehandler/GestureHandler;->mHitSlop:[F
    ...
    .line 385
    iget-object v7, p0, Lversioned/host/exp/exponent/modules/api/components/gesturehandler/GestureHandler;->mHitSlop:[F
    ...
    .line 409
    invoke-static {v4}, Lversioned/host/exp/exponent/modules/api/components/gesturehandler/GestureHandler;->hitSlopSet(F)Z
