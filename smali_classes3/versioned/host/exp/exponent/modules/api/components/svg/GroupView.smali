...
.method draw(Landroid/graphics/Canvas;Landroid/graphics/Paint;F)V
    ...
    .line 80
    invoke-virtual {p0, p1, p2}, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->clip(Landroid/graphics/Canvas;Landroid/graphics/Paint;)V
...
.method drawGroup(Landroid/graphics/Canvas;Landroid/graphics/Paint;F)V
    ...
    .line 87
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->getSvgView()Lversioned/host/exp/exponent/modules/api/components/svg/SvgView;
    ...
    .line 90
    :goto_0
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->getChildCount()I
    ...
    .line 91
    invoke-virtual {p0, v2}, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->getChildAt(I)Landroid/view/View;
    ...
    .line 101
    :cond_1
    iget-object v5, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mCTM:Landroid/graphics/Matrix;
    ...
    .line 102
    iget v6, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mOpacity:F
    ...
    .line 125
    :cond_6
    invoke-virtual {p0, v1}, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->setClientRect(Landroid/graphics/RectF;)V
...
.method getPath(Landroid/graphics/Canvas;Landroid/graphics/Paint;)Landroid/graphics/Path;
    ...
    .line 135
    iget-object v0, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mPath:Landroid/graphics/Path;

    if-eqz v0, :cond_0

    .line 136
    iget-object p1, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mPath:Landroid/graphics/Path;
    ...
    iput-object v0, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mPath:Landroid/graphics/Path;
    ...
    .line 141
    invoke-virtual {p0, v0}, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->getChildAt(I)Landroid/view/View;
    ...
    .line 148
    iget-object v3, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mPath:Landroid/graphics/Path;
...
.method getTextRootGlyphContext()Lversioned/host/exp/exponent/modules/api/components/svg/GlyphContext;
    ...
    .line 66
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->getTextRoot()Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;
...
.method hitTest([F)I
    ...
    .line 212
    iget-boolean v0, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mInvertible:Z

    const/4 v1, -0x1

    if-eqz v0, :cond_9

    iget-boolean v0, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mTransformInvertible:Z
    ...
    .line 217
    iget-object v2, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mInvMatrix:Landroid/graphics/Matrix;

    invoke-virtual {v2, v0, p1}, Landroid/graphics/Matrix;->mapPoints([F[F)V

    .line 218
    iget-object p1, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mInvTransform:Landroid/graphics/Matrix;
    ...
    .line 223
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->getClipPath()Landroid/graphics/Path;
    ...
    .line 225
    iget-object v6, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mClipRegionPath:Landroid/graphics/Path;

    if-eq v6, v5, :cond_1

    .line 226
    iput-object v5, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mClipRegionPath:Landroid/graphics/Path;
    ...
    iput-object v6, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mClipBounds:Landroid/graphics/RectF;

    .line 228
    iget-object v6, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mClipBounds:Landroid/graphics/RectF;
    ...
    invoke-virtual {p0, v5, v6}, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->getRegion(Landroid/graphics/Path;Landroid/graphics/RectF;)Landroid/graphics/Region;

    move-result-object v5

    iput-object v5, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mClipRegion:Landroid/graphics/Region;

    .line 231
    :cond_1
    iget-object v5, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mClipRegion:Landroid/graphics/Region;
    ...
    :cond_4
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->getId()I
...
.method saveDefinition()V
    ...
    .line 263
    iget-object v0, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mName:Ljava/lang/String;
    ...
    iget-object v1, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mName:Ljava/lang/String;
...
.method public setFont(Lcom/facebook/react/bridge/ReadableMap;)V
    ...
    .line 41
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->invalidate()V
...
.method setupGlyphContext(Landroid/graphics/Canvas;)V
    ...
    .line 46
    iget-object p1, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mMatrix:Landroid/graphics/Matrix;
    ...
    .line 49
    :cond_0
    iget-object p1, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mTransform:Landroid/graphics/Matrix;
    ...
    iget v1, p0, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->mScale:F
