...
.method clearCache()V
    ...
    .line 60
    invoke-super {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->clearCache()V
...
.method draw(Landroid/graphics/Canvas;Landroid/graphics/Paint;F)V
    ...
    .line 148
    invoke-virtual {p0, p1}, Lversioned/host/exp/exponent/modules/api/components/svg/TextView;->setupGlyphContext(Landroid/graphics/Canvas;)V

    .line 149
    invoke-virtual {p0, p1, p2}, Lversioned/host/exp/exponent/modules/api/components/svg/TextView;->clip(Landroid/graphics/Canvas;Landroid/graphics/Paint;)V
    ...
    .line 152
    invoke-virtual {p0, p1, p2, p3}, Lversioned/host/exp/exponent/modules/api/components/svg/TextView;->drawGroup(Landroid/graphics/Canvas;Landroid/graphics/Paint;F)V

    .line 153
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/TextView;->popGlyphContext()V
...
.method getAlignmentBaseline()Lversioned/host/exp/exponent/modules/api/components/svg/TextProperties$AlignmentBaseline;
    ...
    .line 173
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/TextView;->getParent()Landroid/view/ViewParent;
...
.method getGroupPath(Landroid/graphics/Canvas;Landroid/graphics/Paint;)Landroid/graphics/Path;
    ...
    .line 211
    iget-object v0, p0, Lversioned/host/exp/exponent/modules/api/components/svg/TextView;->mPath:Landroid/graphics/Path;

    if-eqz v0, :cond_0

    .line 212
    iget-object p1, p0, Lversioned/host/exp/exponent/modules/api/components/svg/TextView;->mPath:Landroid/graphics/Path;
    ...
    iput-object p1, p0, Lversioned/host/exp/exponent/modules/api/components/svg/TextView;->mPath:Landroid/graphics/Path;
...
.method getSubtreeTextChunksTotalAdvance(Landroid/graphics/Paint;)D
    ...
    .line 247
    :goto_0
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/TextView;->getChildCount()I
    ...
    .line 248
    invoke-virtual {p0, v2}, Lversioned/host/exp/exponent/modules/api/components/svg/TextView;->getChildAt(I)Landroid/view/View;
...
.method getTextAnchorRoot()Lversioned/host/exp/exponent/modules/api/components/svg/TextView;
    ...
    .line 228
    invoke-virtual {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/TextView;->getTextRootGlyphContext()Lversioned/host/exp/exponent/modules/api/components/svg/GlyphContext;
    ...
    .line 237
    invoke-virtual {v3}, Lversioned/host/exp/exponent/modules/api/components/svg/TextView;->getParent()Landroid/view/ViewParent;
...
.method getTextContainer()Lversioned/host/exp/exponent/modules/api/components/svg/TextView;
    ...
    .line 263
    invoke-virtual {v1}, Lversioned/host/exp/exponent/modules/api/components/svg/TextView;->getParent()Landroid/view/ViewParent;
...
.method public invalidate()V
    ...
    .line 54
    :cond_0
    invoke-super {p0}, Lversioned/host/exp/exponent/modules/api/components/svg/GroupView;->invalidate()V
    ...
    invoke-virtual {v0}, Lversioned/host/exp/exponent/modules/api/components/svg/TextView;->clearChildCache()V
...
.method pushGlyphContext()V
    ...
    iget-object v4, p0, Lversioned/host/exp/exponent/modules/api/components/svg/TextView;->mFont:Lcom/facebook/react/bridge/ReadableMap;
