...
.method setupPaint(Landroid/graphics/Paint;Landroid/graphics/RectF;FF)V
    ...
    iget-object v0, v0, Lversioned/host/exp/exponent/modules/api/components/svg/PatternView;->mAlign:Ljava/lang/String;

    iget-object v1, v6, Lversioned/host/exp/exponent/modules/api/components/svg/Brush;->mPattern:Lversioned/host/exp/exponent/modules/api/components/svg/PatternView;

    iget v1, v1, Lversioned/host/exp/exponent/modules/api/components/svg/PatternView;->mMeetOrSlice:I

    invoke-static {v4, v5, v0, v1}, Lversioned/host/exp/exponent/modules/api/components/svg/ViewBox;->getTransform(Landroid/graphics/RectF;Landroid/graphics/RectF;Ljava/lang/String;I)Landroid/graphics/Matrix;
    ...
    invoke-virtual {v0, v3, v1, v4}, Lversioned/host/exp/exponent/modules/api/components/svg/PatternView;->draw(Landroid/graphics/Canvas;Landroid/graphics/Paint;F)V
    ...
    .line 165
    iget-object v9, v6, Lversioned/host/exp/exponent/modules/api/components/svg/Brush;->mColors:Lcom/facebook/react/bridge/ReadableArray;

    invoke-static {v9, v0, v5, v3, v4}, Lversioned/host/exp/exponent/modules/api/components/svg/Brush;->parseGradientStops(Lcom/facebook/react/bridge/ReadableArray;I[F[IF)V
    ...
    .line 200
    iget-object v1, v6, Lversioned/host/exp/exponent/modules/api/components/svg/Brush;->mType:Lversioned/host/exp/exponent/modules/api/components/svg/Brush$BrushType;
    ...
    .line 201
    iget-object v1, v6, Lversioned/host/exp/exponent/modules/api/components/svg/Brush;->mPoints:[Lversioned/host/exp/exponent/modules/api/components/svg/SVGLength;
    ...
    .line 225
    iget-object v3, v1, Lversioned/host/exp/exponent/modules/api/components/svg/Brush;->mMatrix:Landroid/graphics/Matrix;
