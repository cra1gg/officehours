...
.method public onRotation(Lversioned/host/exp/exponent/modules/api/components/gesturehandler/RotationGestureDetector;)Z
    ...
    iget-object v3, p0, Lversioned/host/exp/exponent/modules/api/components/gesturehandler/RotationGestureHandler$1;->this$0:Lversioned/host/exp/exponent/modules/api/components/gesturehandler/RotationGestureHandler;

    invoke-static {v3}, Lversioned/host/exp/exponent/modules/api/components/gesturehandler/RotationGestureHandler;->access$000(Lversioned/host/exp/exponent/modules/api/components/gesturehandler/RotationGestureHandler;)D
    ...
    iget-object v4, p0, Lversioned/host/exp/exponent/modules/api/components/gesturehandler/RotationGestureHandler$1;->this$0:Lversioned/host/exp/exponent/modules/api/components/gesturehandler/RotationGestureHandler;

    invoke-static {v4}, Lversioned/host/exp/exponent/modules/api/components/gesturehandler/RotationGestureHandler;->access$000(Lversioned/host/exp/exponent/modules/api/components/gesturehandler/RotationGestureHandler;)D
    ...
    invoke-virtual {p1}, Lversioned/host/exp/exponent/modules/api/components/gesturehandler/RotationGestureHandler;->getState()I
    ...
    invoke-virtual {p1}, Lversioned/host/exp/exponent/modules/api/components/gesturehandler/RotationGestureHandler;->activate()V
...
.method public onRotationEnd(Lversioned/host/exp/exponent/modules/api/components/gesturehandler/RotationGestureDetector;)V
    ...
    invoke-virtual {p1}, Lversioned/host/exp/exponent/modules/api/components/gesturehandler/RotationGestureHandler;->end()V
