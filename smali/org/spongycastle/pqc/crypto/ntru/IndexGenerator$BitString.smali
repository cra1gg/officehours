...
.method public a(I)Lorg/spongycastle/pqc/crypto/ntru/IndexGenerator$BitString;
    ...
    iput v1, v0, Lorg/spongycastle/pqc/crypto/ntru/IndexGenerator$BitString;->b:I

    .line 180
    iget v1, v0, Lorg/spongycastle/pqc/crypto/ntru/IndexGenerator$BitString;->b:I

    new-array v1, v1, [B

    iput-object v1, v0, Lorg/spongycastle/pqc/crypto/ntru/IndexGenerator$BitString;->a:[B

    const/4 v1, 0x0

    .line 181
    :goto_0
    iget v3, v0, Lorg/spongycastle/pqc/crypto/ntru/IndexGenerator$BitString;->b:I

    if-ge v1, v3, :cond_0

    .line 183
    iget-object v3, v0, Lorg/spongycastle/pqc/crypto/ntru/IndexGenerator$BitString;->a:[B

    iget-object v4, p0, Lorg/spongycastle/pqc/crypto/ntru/IndexGenerator$BitString;->a:[B
    ...
    iput p1, v0, Lorg/spongycastle/pqc/crypto/ntru/IndexGenerator$BitString;->c:I

    .line 187
    iget p1, v0, Lorg/spongycastle/pqc/crypto/ntru/IndexGenerator$BitString;->c:I

    if-nez p1, :cond_1

    .line 189
    iput v2, v0, Lorg/spongycastle/pqc/crypto/ntru/IndexGenerator$BitString;->c:I
    ...
    .line 194
    iget-object v1, v0, Lorg/spongycastle/pqc/crypto/ntru/IndexGenerator$BitString;->a:[B

    iget v2, v0, Lorg/spongycastle/pqc/crypto/ntru/IndexGenerator$BitString;->b:I

    add-int/lit8 v2, v2, -0x1

    iget-object v3, v0, Lorg/spongycastle/pqc/crypto/ntru/IndexGenerator$BitString;->a:[B

    iget v4, v0, Lorg/spongycastle/pqc/crypto/ntru/IndexGenerator$BitString;->b:I
...
.method public a(B)V
    ...
    .line 156
    iput v1, p0, Lorg/spongycastle/pqc/crypto/ntru/IndexGenerator$BitString;->c:I
    ...
    iget v4, p0, Lorg/spongycastle/pqc/crypto/ntru/IndexGenerator$BitString;->c:I
...
.method public b(I)I
    ...
    .line 216
    iget-object v2, p0, Lorg/spongycastle/pqc/crypto/ntru/IndexGenerator$BitString;->a:[B
