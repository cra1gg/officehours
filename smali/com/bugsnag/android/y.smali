...
# virtual methods
.method a(Ljava/lang/String;Lcom/bugsnag/android/aq$a;Ljava/util/Map;)I
    .locals 5
    ...
    .line 54
    :cond_0
    new-instance p1, Lcom/bugsnag/android/aa;

    const-string p2, "No network connection available"

    invoke-direct {p1, p2, v1}, Lcom/bugsnag/android/aa;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    .line 75
    new-instance p3, Lcom/bugsnag/android/aq;

    invoke-direct {p3, v3}, Lcom/bugsnag/android/aq;-><init>(Ljava/io/Writer;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_1

    .line 76
    :try_start_3
    invoke-interface {p2, p3}, Lcom/bugsnag/android/aq$a;->toStream(Lcom/bugsnag/android/aq;)V
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_0

    .line 78
    :try_start_4
    invoke-static {p3}, Lcom/bugsnag/android/am;->a(Ljava/io/Closeable;)V
    ...
    .line 89
    invoke-static {p1}, Lcom/bugsnag/android/am;->a(Ljava/net/URLConnection;)V
    ...
    :goto_2
    :try_start_5
    invoke-static {v1}, Lcom/bugsnag/android/am;->a(Ljava/io/Closeable;)V
    ...
    .line 89
    invoke-static {v1}, Lcom/bugsnag/android/am;->a(Ljava/net/URLConnection;)V
    ...
    invoke-direct {p1, p3, p2}, Lcom/bugsnag/android/aa;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public a(Lcom/bugsnag/android/ax;Lcom/bugsnag/android/s;)V
    .locals 1

    .line 39
    invoke-virtual {p2}, Lcom/bugsnag/android/s;->e()Ljava/lang/String;

    move-result-object v0

    .line 40
    invoke-virtual {p2}, Lcom/bugsnag/android/s;->z()Ljava/util/Map;

    move-result-object p2

    invoke-virtual {p0, v0, p1, p2}, Lcom/bugsnag/android/y;->a(Ljava/lang/String;Lcom/bugsnag/android/aq$a;Ljava/util/Map;)I
...
.method public a(Lcom/bugsnag/android/bb;Lcom/bugsnag/android/s;)V
    .locals 1

    .line 26
    invoke-virtual {p2}, Lcom/bugsnag/android/s;->f()Ljava/lang/String;
