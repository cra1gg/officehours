...
.method private containsAsync(Lcom/facebook/cache/common/CacheKey;)Lb/j;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private foundPinnedImage(Lcom/facebook/cache/common/CacheKey;Lcom/facebook/imagepipeline/image/EncodedImage;)Lb/j;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 358
    invoke-static {p2}, Lb/j;->a(Ljava/lang/Object;)Lb/j;
...
.method private getAsync(Lcom/facebook/cache/common/CacheKey;Ljava/util/concurrent/atomic/AtomicBoolean;)Lb/j;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, p2}, Lb/j;->a(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;)Lb/j;
    ...
    .line 234
    invoke-static {p2}, Lb/j;->a(Ljava/lang/Exception;)Lb/j;
...
.method public contains(Lcom/facebook/cache/common/CacheKey;)Lb/j;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 86
    :cond_0
    invoke-direct {p0, p1}, Lcom/facebook/imagepipeline/cache/BufferedDiskCache;->containsAsync(Lcom/facebook/cache/common/CacheKey;)Lb/j;
...
.method public get(Lcom/facebook/cache/common/CacheKey;Ljava/util/concurrent/atomic/AtomicBoolean;)Lb/j;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 138
    invoke-direct {p0, p1, v0}, Lcom/facebook/imagepipeline/cache/BufferedDiskCache;->foundPinnedImage(Lcom/facebook/cache/common/CacheKey;Lcom/facebook/imagepipeline/image/EncodedImage;)Lb/j;
    ...
    :cond_2
    :try_start_1
    invoke-direct {p0, p1, p2}, Lcom/facebook/imagepipeline/cache/BufferedDiskCache;->getAsync(Lcom/facebook/cache/common/CacheKey;Ljava/util/concurrent/atomic/AtomicBoolean;)Lb/j;
...
.method public remove(Lcom/facebook/cache/common/CacheKey;)Lb/j;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
